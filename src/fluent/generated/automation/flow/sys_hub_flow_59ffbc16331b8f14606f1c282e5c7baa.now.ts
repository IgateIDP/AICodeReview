...
Record({
    ...
    data: {
        ...
        attributes:
            'browserActivatedIn=chrome,integrationActivatedIn=standalone,labelCacheCleanUpExecuted=true,timeFromCreateToActivate=18668000,viewActivatedIn=naturalLanguage',
...
Record({
    ...
    data: {
        plan: 'com.snc.process_flow.engine.ProcessPlan@79932165',
