...
Record({
    ...
    data: {
        ...
        attributes:
            'browserActivatedIn=chrome,integrationActivatedIn=standalone,labelCacheCleanUpExecuted=true,timeFromCreateToActivate=93659000,viewActivatedIn=naturalLanguage',
...
Record({
    ...
    data: {
        plan: 'com.snc.process_flow.engine.ProcessPlan@71562d2',
